...
function add_video_form($video_details = array())
{
	...
	{
		$video_lookup = pm_alert_warning('<strong>Sorry, no video found at this location.</strong> Please try again or use another video source/source. <a href="http://www.phpsugar.com/customer_care.html" target="_blank" class="btn btn-mini btn-blue pull-right">SUGGEST NEW SOURCE</a>');
	}
			...
			else
			{
				...
				else	//	Everything is good. Now we can add the new video to the database
				{
					...
					else
					{
						...
						echo '<a href="import.php" name="import_new" class="btn btn-small" />Import from YouTube</a></div>';
