...
function show_pm_notes() {
	...
	if (_CUSTOMER_ID == 'YOUR_CUSTOMER_ID') 
	{
		...
		$txt_notes[$i]['desc']  = 'The Customer ID in <strong>config.php</strong> is <strong>invalid</strong>. Update <strong>config.php</strong> with your real Customer ID which is available in your <a href="https://www.phpsugar.com/customer/">Customer Account</a>.';
		$txt_notes[$i]['ico']  = 'gritter-ico_warn.png';
