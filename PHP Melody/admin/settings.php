...
else if ($_POST['submit'] == "Save")
{
	...
	if($info_msg == '')
	{
		...
		{
			$info_msg = 'File "/'. _ADMIN_FOLDER .'/temp/embedparams.xml" is not writable. Please CHMOD this file to 0777 and retry.';
		}
		...
		if ($config['video_player'] == 'jwplayer' || $_POST['video_player'] == 'jwplayer')
		{
			...
			{
				$info_msg = 'File "/players/jwplayer5/jwembed.xml" is not writable. Please CHMOD this file to 0777 and retry.';
			}
		}
	}
	...
	{
		$info_msg = 'reCAPTCHA requires both a public and a private key. You can get them for free by signing up at <a href="http://www.google.com/recaptcha/intro/index.html" target="_blank">http://www.google.com/recaptcha/intro/index.html</a>.';
	}
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
   ...
   <table cellpadding="0" cellspacing="0" width="100%" class="table table-striped table-bordered pm-tables pm-tables-settings">
	...
	?>
		...
		<strong><?php echo _SITENAME; ?> can't send any emails at this time</strong>.
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="table table-striped table-bordered pm-tables pm-tables-settings">
	 ...
	 <tr>
		<td width="20%">Auto-approve user suggested &amp; uploaded videos</td>
		<td>
